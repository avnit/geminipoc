resource "google_compute_disk" "gke_primary_gke_clus_primary_node_poo_dc619f79_vdze" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-primary-gke-clus-primary-node-poo-dc619f79-vdze"
...
# terraform import google_compute_disk.gke_primary_gke_clus_primary_node_poo_dc619f79_vdze projects/avathon-saas-runtime-setup/zones/us-central1-a/disks/gke-primary-gke-clus-primary-node-poo-dc619f79-vdze
