resource "google_compute_disk" "gke_primary_gke_clus_primary_node_poo_be30a3d2_wztb" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-primary-gke-clus-primary-node-poo-be30a3d2-wztb"
...
# terraform import google_compute_disk.gke_primary_gke_clus_primary_node_poo_be30a3d2_wztb projects/avathon-saas-runtime-setup/zones/us-central1-f/disks/gke-primary-gke-clus-primary-node-poo-be30a3d2-wztb
