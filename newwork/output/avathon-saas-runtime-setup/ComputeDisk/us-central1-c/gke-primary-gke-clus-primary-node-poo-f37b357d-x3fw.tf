resource "google_compute_disk" "gke_primary_gke_clus_primary_node_poo_f37b357d_x3fw" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-primary-gke-clus-primary-node-poo-f37b357d-x3fw"
...
# terraform import google_compute_disk.gke_primary_gke_clus_primary_node_poo_f37b357d_x3fw projects/avathon-saas-runtime-setup/zones/us-central1-c/disks/gke-primary-gke-clus-primary-node-poo-f37b357d-x3fw
